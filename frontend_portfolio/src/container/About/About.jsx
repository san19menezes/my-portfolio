  ...
  return (
    <>
      ...
      <h2 className='about-head-text'>
        I have been a highly motivated Web Developer with a long-standing
        background of 7+ years in the industry. I'm passionate about building UI
        components and creating intuitive, dynamic user experiences.
